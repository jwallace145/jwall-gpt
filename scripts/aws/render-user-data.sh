...
export GITHUB_REPO PROJECT_NAME MAX_STEPS

envsubst '$RELEASE_TAG $TRAINING_CONFIG $TRAINING_BUCKET $DATASETS_BUCKET $DATASET $TOKENIZER $GITHUB_REPO $PROJECT_NAME $MAX_STEPS' < "${TEMPLATE}"
